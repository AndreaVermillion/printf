...
void    ft_select_args_group3_len_2(t_data *a, va_list arg) // VERIFIED
{
    if (a->spe == 'D')
    {
...
void    ft_select_args_group3_len_1_part1(t_data *a, va_list arg) // VERIFIED
{
    if (a->len[0] == 'l')
    {
        a->a_g3_D_l = va_arg(arg, long int);
...
void    ft_select_args_group3_len_1(t_data *a, va_list arg) // VERIFIED
{
    if (a->spe == 'D')
    {
        a->a_g3_D_l = va_arg(arg, long int);
